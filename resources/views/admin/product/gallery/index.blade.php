...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>Product Gallery for {{ $product->name }}</h1>
        </div>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.product-gallery.destroy', $image->id) }}" class='btn btn-danger mx-2 delete-item'><i class='fas fa-trash'></i></a>
                            </td>
                        </tr>
                        @endforeach
                        @if (count($images) === 0)
